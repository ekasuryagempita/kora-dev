...
import { cn } from "@/lib/utils" // Jalur import diperbaiki
import { Slot } from "@radix-ui/react-slot" // Jalur import diperbaiki

const buttonVariants = cva(
  // rounded-none dan uppercase dihapus. Diganti text-sm dan rounded-md agar elegan & mengikuti Rule 68 KORA
